 ...
 * Operates on 80-byte Bitcoin-compatible block headers
 */

// Initial SHA-256 state constants
...
export function sha256Transform(w: Uint32Array, state: Uint32Array): void {
...
/**
 * Computes single SHA-256 hash of a Uint8Array
 */
...
/**
 * Computes SHA-256d (SHA256(SHA256(header)))
 */
...
/**
 * Converts Uint8Array hash to Hex String (Big-Endian or Little-Endian display)
 */
export function bytesToHex(bytes: Uint8Array, reverse = false): string {
